    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('blogs/add')}}" method="post" name="addBlog" id="addBlog">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="content" cols="20" rows="15" class="form-control {{($errors->any() && $errors->first('content')) ? 'is-invalid' : ''}}">{{old('content')}}</textarea>
                                @if($errors->any())
                            ...
                            <div class="form-group">
                                <button type="submit" name="submit" class="btn btn-primary" style="margin-top: 20px;">Save blog</button>
                            </div>
                        </form>
                    </div>
                </div>
